...
// WithSensorID adds the sensorID to the get status params
func (o *GetStatusParams) WithSensorID(sensorID string) *GetStatusParams {
	o.SetSensorID(sensorID)
	return o
}

// SetSensorID adds the sensorId to the get status params
func (o *GetStatusParams) SetSensorID(sensorID string) {
	o.SensorID = sensorID
}
