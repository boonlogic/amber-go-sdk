...
func (m *PostAuth2Request) validatePassword(formats strfmt.Registry) error {
...
func (m *PostAuth2Request) validateUsername(formats strfmt.Registry) error {
