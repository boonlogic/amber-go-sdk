...
func (m *StreamStatus) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateLastModifiedDelta(formats); err != nil {
		res = append(res, err)
	}
...
func (m *StreamStatus) validateLastModified(formats strfmt.Registry) error {
...
func (m *StreamStatus) validateLastModifiedDelta(formats strfmt.Registry) error {

	if err := validate.Required("lastModifiedDelta", "body", m.LastModifiedDelta); err != nil {
		return err
	}
