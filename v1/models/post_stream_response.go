...
func (m *PostStreamResponse) Validate(formats strfmt.Registry) error {
	...
	if err := m.validatePI(formats); err != nil {
		res = append(res, err)
	}
...
func (m *PostStreamResponse) validatePI(formats strfmt.Registry) error {

	if err := validate.Required("PI", "body", m.PI); err != nil {
		return err
	}

	if err := m.PI.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("PI")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("PI")
		}
		return err
	}
...
func (m *PostStreamResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidatePI(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *PostStreamResponse) contextValidatePI(ctx context.Context, formats strfmt.Registry) error {

	if err := m.PI.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("PI")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("PI")
