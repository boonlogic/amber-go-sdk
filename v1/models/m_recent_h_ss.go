...
func (m *MRecentHSs) validateVersionNumber(formats strfmt.Registry) error {
...
func (m *MRecentHSs) validateMValues(formats strfmt.Registry) error {
...
func (m *MRecentHSs) contextValidateVersionNumber(ctx context.Context, formats strfmt.Registry) error {
