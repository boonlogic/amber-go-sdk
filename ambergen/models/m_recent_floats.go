...
func (m *MRecentFloats) validateVersionNumber(formats strfmt.Registry) error {
...
func (m *MRecentFloats) validateMValues(formats strfmt.Registry) error {
...
func (m *MRecentFloats) contextValidateVersionNumber(ctx context.Context, formats strfmt.Registry) error {
