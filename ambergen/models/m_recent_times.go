...
func (m *MRecentTimes) validateVersionNumber(formats strfmt.Registry) error {
...
func (m *MRecentTimes) validateMValues(formats strfmt.Registry) error {
...
func (m *MRecentTimes) contextValidateVersionNumber(ctx context.Context, formats strfmt.Registry) error {
