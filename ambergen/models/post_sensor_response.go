...
func (m *PostSensorResponse) validateLabel(formats strfmt.Registry) error {
...
func (m *PostSensorResponse) validateSensorID(formats strfmt.Registry) error {
