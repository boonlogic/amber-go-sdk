...
// WithSensorID adds the sensorID to the get config params
func (o *GetConfigParams) WithSensorID(sensorID string) *GetConfigParams {
	o.SetSensorID(sensorID)
	return o
}

// SetSensorID adds the sensorId to the get config params
func (o *GetConfigParams) SetSensorID(sensorID string) {
	o.SensorID = sensorID
}
