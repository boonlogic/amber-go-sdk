...
func (m *MRecentAMs) validateVersionNumber(formats strfmt.Registry) error {
...
func (m *MRecentAMs) validateMValues(formats strfmt.Registry) error {
...
func (m *MRecentAMs) contextValidateVersionNumber(ctx context.Context, formats strfmt.Registry) error {
